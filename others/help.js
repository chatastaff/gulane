...
module.exports = {
  ...
  aliases: ["h","commands"],
  cooldown: 5,
  edesc: "Type help to get a short preview of all Commands, Type help <COMMAND> to get extended information about this one command!",
